...
class PlannerAgent(BaseReActAgent):
    ...
    def _create_goals_from_intents(self, intent_nodes: list) -> list[Goal]:
        ...
        intent_to_goal_type = {
            ...
            "news": "news",
            "emergency": "emergency",
            "general": "legal_contract_review",
            "unknown": "legal_contract_review",
            # 咨询团队映射
            "legal": "legal_contract_review",
            "legal_contract_review": "legal_contract_review",
            "legal_rights_protection": "legal_rights_protection",
            "legal_compliance_check": "legal_compliance_check",
            "medical": "medical_symptom_analysis",
            "medical_symptom_analysis": "medical_symptom_analysis",
            "medical_disease_info": "medical_disease_info",
            "medical_hospital_recommend": "medical_hospital_recommend",
            "emotional": "emotional_emotion_listen",
            "emotional_emotion_listen": "emotional_emotion_listen",
            "emotional_relationship_consult": "emotional_relationship_consult",
            "emotional_family_communication": "emotional_family_communication",
            "emotional_social_advice": "emotional_social_advice",
            "emotional_self_discovery": "emotional_self_discovery",
            "finance": "finance_budget_planning",
            "finance_investment_analysis": "finance_investment_analysis",
            "finance_budget_planning": "finance_budget_planning",
            "finance_tax_consult": "finance_tax_consult",
            "finance_retirement_plan": "finance_retirement_plan",
            "learning": "learning_study_plan",
            "learning_study_plan": "learning_study_plan",
            "learning_skill_learning": "learning_skill_learning",
            "learning_exam_prepare": "learning_exam_prepare",
            "learning_time_management": "learning_time_management",
            "travel": "travel_trip_plan",
            "travel_trip_plan": "travel_trip_plan",
            "travel_hotel_book": "travel_hotel_book",
            "travel_visa_consult": "travel_visa_consult",
            "travel_spot_recommend": "travel_spot_recommend",
        }
